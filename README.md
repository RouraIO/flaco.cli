...
Flaco AI is built on top of Aider by Paul Gauthier and the Aider team. We've transformed it into a specialized Swift/iOS development assistant with enhanced Jira integration, project memory, and local LLM support.
