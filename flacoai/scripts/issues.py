...
Note: [A bot script](https://github.com/flacoai-AI/flacoai/blob/main/scripts/issues.py) made these updates to the issue.
"""  # noqa
...
CLOSE_FIXED_ENHANCEMENT_COMMENT = (
    ...
    """3 weeks. The requested feature should now be available in recent versions of flacoai.\n\n"""
...
CLOSE_FIXED_BUG_COMMENT = (
    ...
    """3 weeks. This issue should be resolved in recent versions of flacoai.\n\n"""
