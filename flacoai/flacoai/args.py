...
from flacoai import __version__
from flacoai.args_formatter import (
    DotEnvFormatter,
    MarkdownHelpFormatter,
    YamlHelpFormatter,
)
from flacoai.deprecated import add_deprecated_model_args
...
def get_parser(default_config_files, git_root):
    ...
    from flacoai import coders as _aider_coders
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Show FlacoAI branded startup UI with ASCII art and activity stats (default: True)",
    )
    group.add_argument(
        "--stream",
        action=argparse.BooleanOptionalAction,
    ...
    group.add_argument(
        ...
        default="#00FFFF",
        help="Set the color for assistant output (default: #00FFFF - cyan)",
    )
    group.add_argument(
