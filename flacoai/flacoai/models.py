...
from flacoai.openrouter import OpenRouterModelManager
from flacoai.sendchat import ensure_alternating_roles, sanity_check_messages
from flacoai.utils import check_pip_install_extra
...
MODEL_SETTINGS = []
with importlib.resources.open_text("flacoai.resources", "model-settings.yml") as f:
