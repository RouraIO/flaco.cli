...
from flacoai.urls import github_issues
from flacoai.versioncheck import VERSION_CHECK_FNAME
...
def report_github_issue(issue_text, title=None, confirm=True):
    ...
    if confirm:
        ...
        print()
        print("Please consider reporting this bug to help improve flacoai!")
