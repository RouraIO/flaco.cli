...
# Make pydub optional for Python 3.14 compatibility (audioop removed)
try:
...
class Voice:
    ...
    def __init__(self, audio_format="wav", device_name=None):
        if not PYDUB_AVAILABLE:
            raise SoundDeviceError("Voice features not available: pydub/audioop not compatible with Python 3.14+")
        if sf is None:
